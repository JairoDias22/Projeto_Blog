      ...
      <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="http://localhost/projeto-blog/">Home <span class="sr-only">(página atual)</span></a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="http://localhost/Projeto-blog/">Pagina inicial</a>
              <a class="dropdown-item" href="http://localhost/projeto-blog/contato.php">Contato</a>
